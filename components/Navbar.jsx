    ...
    <nav className="bg-black text-white">
      ...
      <div className={nav ? "md:hidden fixed top-0 left-0 right-0 bottom-0 w-full h-screen bg-black/90 text-white flex justify-center items-center text-center ease-in duration-300 z-10" : "md:hidden absolute top-0 left-[-100%] right-0 bottom-0 w-full h-screen bg-black/90 text-white rounded-md flex justify-center items-center text-center ease-out duration-300 z-10"}>
        <ul className="flex flex-col gap-y-3">
          ...
          <li className="text-2xl hover:text-gray-400"><Link href="/contact">{t('contact.section_title')}</Link></li>
          {i18n.language === 'en' ?
            <li><button onClick={() => {
              i18n.changeLanguage('de')
            }}
              className="m-1 w-fit">
              <svg aria-hidden="true" className="h-10 w-10 rounded-full hover:border-2 hover:border-solid" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-de" viewBox="0 0 512 512"><path fill="#ffce00" d="M0 341.3h512V512H0z" /><path d="M0 0h512v170.7H0z" /><path fill="#d00" d="M0 170.7h512v170.6H0z" /></svg>
            </button></li>
            :
            <li><button onClick={() => {
      ...
      <div className="navbar-end hidden md:flex md:justify-between w-full px-8 py-4">
        ...
        <ul className="flex justify-self gap-x-8 items-center">
          ...
          <li className="hover:text-gray-400"><Link href="/artworks">{t('artworks.section_title')}</Link></li>
          <li className="hover:text-gray-400"><Link href="/contact">{t('contact.section_title')}</Link></li>
          {i18n.language === 'en' ?
            <li><button onClick={() => {
              i18n.changeLanguage('de')
            }}
